...
String operatorButtonText[] = {"/", "sqrt", "*", "%", "-", "Pow", "+","n√k","cbrt", "=" };  
...
if(opText.equals("Pow"))  
    {  
    try  
        {double l = cl.number,m=temp;  
        double tempd = Math.pow(l,m);
...
if(opText.equals("sqrt"))  
    ...
    if(opText.equals("n√k"))  
    {  
try
     {double k = cl.number,n=temp;
        double tempd = Math.pow(k, ((1.0 / k) *
